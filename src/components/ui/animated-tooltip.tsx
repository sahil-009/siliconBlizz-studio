      ...
      {items.map((item) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="object-cover !m-0 !p-0 object-top rounded-full h-14 w-14 border-2 border-border relative transition duration-500 group-hover:scale-105 group-hover:z-30"
          />
        </div>
      ))}
    </>
